	...
	<script src="<?php echo $rootDomaine; ?>js/bootstrap.min.js"></script>
	<script src="<?php echo $rootDomaine; ?>xhr/xhrFunctions.js"></script>
	<script src="<?php echo $rootDomaine; ?>js/functions.js"></script>
