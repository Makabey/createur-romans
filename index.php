...
?>
		...
		<form id="form_register" method="post" action="index.php" class="form-signin" role="form">
			...
			<input type="text" id="registerName" placeholder="Votre nom" pattern="[0-9A-Za-z]{1,40}" title="de 1 à 40 caractères" class="form-control" />
			...
			<input type="password" id="registerPwd" placeholder="Mot de passe" pattern="[0-9A-Za-z]{8,20}" title="de 8 à 20 caractères" class="form-control" required="required" />
			<input type="password" id="registerPwdConf" placeholder="Confirmez le mot de passe" pattern="[0-9A-Za-z]{8,20}" title="de 8 à 20 caractères" class="form-control" required="required" />
