...
(15, 3, 0, 0, 'quand', 'Époque', 'i', NULL, b'0'),
(16, 3, 0, 18, 'qui', 'Protagoniste A', 'o', NULL, b'0'),
(17, 3, 0, 19, 'quoi', 'Situation', 'd', NULL, b'0'),
(18, 3, 16, 0, 'qui', 'Protagoniste B', 'd', NULL, b'0'),
(19, 3, 17, 0, 'quoi', 'Lien entre les acteurs', 'd', NULL, b'0'),
(20, 3, 0, 0, 'ou', 'Endroit', 'ggff; ggfgfggffg', NULL, b'0'),
(21, 3, 0, 0, 'comment', 'Évènement déclencheur', 'ee', NULL, b'0'),
(22, 3, 0, 0, 'pourquoi', 'Pourquoi', 'vvv', NULL, b'0');

-- --------------------------------------------------------

--
-- Structure de la table `genres_litteraires_noms`
--
...
--
-- Contenu de la table `genres_litteraires_noms`
--
...
--
-- Structure de la table `genres_litteraires_questions`
--
...
--
-- Contenu de la table `genres_litteraires_questions`
--
...
--
-- Structure de la table `roman_details`
--
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Tout sauf le texte' AUTO_INCREMENT=4 ;

--
-- Contenu de la table `roman_details`
--

INSERT INTO `roman_details` (`ID_roman`, `ID_usager`, `ID_genre`, `titre`, `date_creation`, `date_dnrEdition`, `deleted`) VALUES
(1, 1, b'00110001', 'Cette Rousse qui détrousse.', '2014-07-02 10:25:29', '2014-07-02 10:25:29', b'0'),
(2, 1, b'00110001', 'La vengeance est Rousse', '2014-07-02 10:36:46', '2014-07-02 10:36:46', b'0'),
(3, 2, b'00110010', '5445654', '0000-00-00 00:00:00', '0000-00-00 00:00:00', b'0');

-- --------------------------------------------------------

--
-- Structure de la table `roman_texte`
--
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Texte seulement' AUTO_INCREMENT=4 ;

--
-- Contenu de la table `roman_texte`
--
...
(3, 3, '=Époque :¤i¯=Protagoniste A :¤o¯=Situation :¤d¯=Protagoniste B :¤d¯=Lien entre les acteurs :¤d¯=Endroit :¤ggff¤ggfgfggffg¯=Évènement déclencheur :¤ee¯=Pourquoi :¤vvv¯', 'Bienvenue dans votre roman! Quel sera le commencement de votre histoire? :)', '=Époque : i\n=Protagoniste A : o\n=Situation : d\n=Protagoniste B : d\n=Lien entre les acteurs : d\n=Endroit : ggff; ggfgfggffg\n=Évènement déclencheur : ee\n=Pourquoi : vvv\n');
...
(2, 'test', 'rienj', 'qwertyui', '', '0000-00-00 00:00:00', b'0'),
(3, 'test', 'rienj', 'qwertyui', '', '0000-00-00 00:00:00', b'0'),
(4, 'test2', 'rrrr', 'qwertyui', '', '0000-00-00 00:00:00', b'0');
