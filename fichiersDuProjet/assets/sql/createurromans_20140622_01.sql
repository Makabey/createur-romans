...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 23, 2014 at 02:44 AM
...
CREATE TABLE IF NOT EXISTS `entites` (
  ...
  `typeEntite` enum('qui','quoi','ou','comment','pourquoi','note') NOT NULL DEFAULT 'note',
...
(1, 1, 3, 5, 'qui', 'Protagoniste A', 'vrai test<br>', 'adipiscing facilisis nibh ut mattis. Aenean tempor sodales urna, sit amet iaculis mauris dapibus et. Aenean nunc velit, tristique tristique fermentum ut, ...', b'0'),
...
(4, 1, 5, 6, 'qui', 'Test1', 'blablablablabla', '', b'0'),
(5, 1, 1, 4, 'qui', 'Test2', 'blablablablabla', '', b'0'),
(6, 1, 4, 7, 'qui', 'Test3', 'blablablablabla', '', b'0'),
(7, 1, 6, 8, 'qui', 'Test4', 'blablablablabla', '', b'0'),
(8, 1, 7, 9, 'qui', 'Test3', 'blab''lablablabla', '', b'0'),
(9, 1, 8, 10, 'qui', 'Test3', 'blab"lablablabla', '', b'0'),
(10, 1, 9, 13, 'qui', 'updated1', 'blab"lablablabla', 'rien', b'0'),
(11, 1, 0, 12, 'quoi', 'Test3', 'blab"lablablabla', '', b'0'),
(12, 1, 11, 0, 'quoi', 'updated2', 'whacka', 'hum', b'0'),
(13, 1, 10, 0, 'qui', 'Test3', 'blab"lablablabla', '', b'0');
